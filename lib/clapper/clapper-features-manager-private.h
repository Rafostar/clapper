...
G_GNUC_INTERNAL
void clapper_features_manager_trigger_position_changed (ClapperFeaturesManager *features, gfloat position);

G_GNUC_INTERNAL
void clapper_features_manager_trigger_speed_changed (ClapperFeaturesManager *features, gfloat speed);

G_GNUC_INTERNAL
void clapper_features_manager_trigger_volume_changed (ClapperFeaturesManager *features, gfloat volume);

G_GNUC_INTERNAL
void clapper_features_manager_trigger_mute_changed (ClapperFeaturesManager *features, gboolean mute);

G_GNUC_INTERNAL
void clapper_features_manager_trigger_current_media_item_changed (ClapperFeaturesManager *features, ClapperMediaItem *item);
