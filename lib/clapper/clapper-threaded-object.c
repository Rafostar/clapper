...
/**
 * SECTION:clapper-threaded-object
 * @title: ClapperThreadedObject
 * @short_description: A base class for objects that spawn their own threads
 */
...
clapper_threaded_object_constructed (GObject *object)
{
  ...
  priv->thread = g_thread_new (G_OBJECT_CLASS_NAME (threaded_object_class),
