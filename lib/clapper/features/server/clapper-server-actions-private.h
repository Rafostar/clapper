...
G_GNUC_INTERNAL
gboolean clapper_server_actions_parse_seek (const gchar *text, gfloat *position);

G_GNUC_INTERNAL
gboolean clapper_server_actions_parse_set_speed (const gchar *text, gfloat *speed);

G_GNUC_INTERNAL
gboolean clapper_server_actions_parse_set_volume (const gchar *text, gfloat *volume);
