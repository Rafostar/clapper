...
G_GNUC_INTERNAL
void clapper_feature_call_position_changed (ClapperFeature *feature, gfloat position);

G_GNUC_INTERNAL
void clapper_feature_call_speed_changed (ClapperFeature *feature, gfloat speed);

G_GNUC_INTERNAL
void clapper_feature_call_volume_changed (ClapperFeature *feature, gfloat volume);

G_GNUC_INTERNAL
void clapper_feature_call_mute_changed (ClapperFeature *feature, gboolean mute);

G_GNUC_INTERNAL
void clapper_feature_call_current_media_item_changed (ClapperFeature *feature, ClapperMediaItem *item);
