...
void clapper_media_item_append_suburi (ClapperMediaItem *item, const gchar *suburi);

void clapper_media_item_set_suburis (ClapperMediaItem *item, const gchar **suburis);

gchar ** clapper_media_item_get_suburis (ClapperMediaItem *item);
