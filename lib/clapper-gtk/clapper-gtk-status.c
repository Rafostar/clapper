...
clapper_gtk_status_set_error (ClapperGtkStatus *self, const GError *error)
{
  ...
  _set_status (self, "computer-fail-symbolic", "Unplayable Content", error->message);
}
...
clapper_gtk_status_set_missing_plugin (ClapperGtkStatus *self, const gchar *name)
{
  ...
  _set_status (self, "dialog-warning-symbolic", "Missing Plugin", description);
...
clapper_gtk_status_class_init (ClapperGtkStatusClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class,
      "/com/github/rafostar/Clapper/clapper-gtk/ui/clapper-gtk-status.ui");
