...
#include <clapper-gtk/clapper-gtk-skip-item-button.h>
...
G_DECLARE_FINAL_TYPE (ClapperGtkPreviousItemButton, clapper_gtk_previous_item_button, CLAPPER_GTK, PREVIOUS_ITEM_BUTTON, ClapperGtkSkipItemButton)
