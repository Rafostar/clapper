...
static void
clapper_gtk_toggle_play_button_clicked (GtkButton* button)
{
  ClapperPlayer *player = clapper_gtk_get_player_from_ancestor (GTK_WIDGET (button));
  ...
  state = clapper_player_get_state (player);
...
clapper_gtk_toggle_play_button_class_init (ClapperGtkTogglePlayButtonClass *klass)
{
  ...
  button_class->clicked = clapper_gtk_toggle_play_button_clicked;
}
