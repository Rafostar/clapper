 ...
 * care of fading itself once clicked and/or playback is started.
 */
 ...
 *
 * Returns: (transfer full): a new playback engage layer #GtkWidget.
 */
GtkWidget *
...
static void
clapper_gtk_engage_layer_finalize (GObject *object)
{
  ClapperGtkEngageLayer *self = CLAPPER_GTK_ENGAGE_LAYER_CAST (object);
...
clapper_gtk_engage_layer_class_init (ClapperGtkEngageLayerClass *klass)
{
  ...
  gobject_class->finalize = clapper_gtk_engage_layer_finalize;

  gtk_widget_class_set_template_from_resource (widget_class,
      "/com/github/rafostar/Clapper/clapper-gtk/ui/clapper-gtk-engage-layer.ui");
