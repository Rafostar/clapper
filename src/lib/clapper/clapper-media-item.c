 ...
 * item with some initial/cached tags to display it in UI before playback.
 *
 * When some tag already exists in the tag list (was populated) this
 * function will not overwrite it. If you really need to permanently
 * override some tags in media, you can use `taginject` element in
