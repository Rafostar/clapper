...
G_GNUC_INTERNAL
GListStore * clapper_enhancer_director_parse (ClapperEnhancerDirector *director, GList *filtered_proxies, GstBuffer *buffer, GCancellable *cancellable, GError **error);
