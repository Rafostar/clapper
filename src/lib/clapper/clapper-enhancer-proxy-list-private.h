...
G_GNUC_INTERNAL
gboolean clapper_enhancer_proxy_list_enhancer_check (ClapperEnhancerProxyList *self, GType iface_type, const gchar *scheme, const gchar *host, const gchar **name);
