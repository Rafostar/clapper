 ...
 *
 * This returns a global list of enhancer proxy objects. Any configuration
 * applied to proxies on this list will also carry over to newly created
 * [class@Clapper.Player] instances. You can also use this to inspect
 * available enhancers without creating new player object.
 *
